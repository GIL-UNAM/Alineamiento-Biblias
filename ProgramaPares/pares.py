...
def mostrar_alineacion(alineacion, f):
    ...
    lista_para_mostrar.append(lcc.distancia_de_edicion(alineacion[2]))
...
def pares_completos(Libro1, Libro2, path):
    ...
    """
    f = open('./Resultados/Pares/Normal/'+path+'.txt', 'w')
    g = open('./Resultados/Alineaciones/Normal/alineaciones-' + path+ '.txt', 'w')
    m = open('./Resultados/Pares/Semi/Seminull-'+path+'.txt', 'w')
    h = open('./Resultados/Pares/Intercambio/Intercambio_'+ path +'.txt', 'w')
    r = open('./Resultados/Alineaciones/Semi/alineacionesSeminiull-'+ path + '.txt', 'w')
    l = open('./Resultados/Alineaciones/Intercambio/alineaciones-Intercambio' + path+ '.txt', 'w')
    a = open('./Resultados/Pares/POS/POS'+path+'.txt', 'w')
    b = open('./Resultados/Alineaciones/POS/POS'+path+'.txt', 'w')
    c = open('./Resultados/Alineaciones/POSsemi/POSsemi'+path+'.txt', 'w')
    d = open('./Resultados/Pares/POSsemi/POSsemi'+path+'.txt', 'w')
